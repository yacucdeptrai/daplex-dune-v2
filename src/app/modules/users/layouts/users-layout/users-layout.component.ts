...
@Component({
    ...
    imports: [TranslocoDirective, LazyLoadImageModule, NgStyle, AvatarComponent, TabsModule, RouterLink, RouterLinkActive, RouterOutlet, RgbColorPipe, SubstringPipe, ThumbhashUrlPipe]
})
