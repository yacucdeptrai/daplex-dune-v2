...
@Component({
    ...
    imports: [TranslocoDirective, ToggleButtonModule, TooltipModule, SelectButtonModule, FormsModule, ReactiveFormsModule, FormHandlerDirective, DatePickerModule, DisabledControlDirective, AutoCompleteModule, RadioButtonModule, SelectModule, ButtonModule, NgClass, InfiniteScrollDirective, HistoryCardComponent, TableModule, SharedModule, LazyLoadImageModule, ProgressBarModule, RouterLink, MenuTriggerDirective, MenuDirective, MenuItemDirective, ConfirmDialogModule, DateAltPipe, RelativeDatePipe, ThumbhashUrlPipe]
})
