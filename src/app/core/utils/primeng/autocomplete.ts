 ...
 * "N items selected" summary token (via the selecteditem template) instead of
 * one chip per item, and restores the hideOnSelect keep-panel-open option.
 * Template is the v21 base with only the multiple container + option click changed.
 */
@Component({
