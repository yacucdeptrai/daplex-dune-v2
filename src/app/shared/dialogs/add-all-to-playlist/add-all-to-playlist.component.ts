...
@Component({
    ...
    imports: [TranslocoDirective, InputTextModule, NgIf, FormsModule, ReactiveFormsModule, FormHandlerDirective, NgFor, RadioButtonModule, DisabledControlDirective, ButtonModule, ProgressSpinnerModule]
})
