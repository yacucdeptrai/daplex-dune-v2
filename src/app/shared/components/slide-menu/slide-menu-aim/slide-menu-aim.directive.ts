// https://github.com/angular/components/blob/main/src/cdk/menu/menu-aim.ts
/**
 * @license
 ...
 */
import { Directive, Injectable, InjectionToken, NgZone, OnDestroy, inject } from '@angular/core';
...
import { SlidePointerFocusTracker } from '../slide-pointer-focus-tracker/slide-pointer-focus-tracker';
import { throwMissingMenuReference, throwMissingPointerFocusTracker } from '../slide-menu-errors';

export interface SlideMenuAim {
  /**
   * Set the Menu and its PointerFocusTracker.
   * @param menu The menu that this menu aim service controls.
   * @param pointerTracker The `PointerFocusTracker` for the given menu.
   */
  initialize(menu: SlideMenuOverlay, pointerTracker: SlidePointerFocusTracker<FocusableElement & Toggler>): void;
...
export const SLIDE_MENU_AIM = new InjectionToken<SlideMenuAim>('slide-menu-aim');
 ...
 */
@Injectable()
export class SlideTargetMenuAim implements SlideMenuAim, OnDestroy {
  /** The Angular zone. */
  ...
  private _menu!: SlideMenuOverlay;

  /** Reference to the root menu's mouse manager. */
  private _pointerTracker!: SlidePointerFocusTracker<Toggler & FocusableElement>;
   ...
   * @param pointerTracker The `PointerFocusTracker` for the given menu.
   */
  initialize(menu: SlideMenuOverlay, pointerTracker: SlidePointerFocusTracker<FocusableElement & Toggler>) {
    this._menu = menu;
  ...
  private _checkConfigured() {
    if (typeof (<any>window).ngDevMode === 'undefined' || (<any>window).ngDevMode) {
...
/**
 * SlideTargetMenuAim is a provider for the TargetMenuAim service. It can be added to an
